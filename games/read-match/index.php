...
<body>
    ...
    <div id="start-overlay">
        <h1 style="color:white; font-size:50px; margin-bottom:10px; text-shadow: 0 4px 0 rgba(0,0,0,0.2);">Reading Mission</h1>
        <p style="color:#ecf0f1; font-size:20px; margin-bottom:40px;">Read the sentence and find the picture.</p>
        
        <div style="display:flex; flex-wrap:wrap; justify-content:center; gap:20px;">
            <button class="start-btn btn-l1" onclick="initGame(1)">
                Level 1: Cadet
                <span class="btn-sub">(2 Choices)</span>
            </button>
            
            <button class="start-btn btn-l2" onclick="initGame(2)">
                Level 2: Commander
                <span class="btn-sub">(4 Choices)</span>
            </button>
        </div>
    </div>
    ...
    <div id="game-area">
        <img id="word-image" src="" alt="Picture">
        
        <div id="sentence-list"></div>
        
        <button id="next-btn" class="next-btn hidden" onclick="loadLevel()">Next Picture ➡</button>
